        ...
        <div class="col-sm-6">
            ...
            <form method="POST" action="{{ route('league.store') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control input-md {{ $errors->has('League') ? ' is-invalid' : '' }}" name="League" placeholder="Eg. English Premier league">
                    @include('alerts.feedback', ['field' => 'League'])
                </div>
                <button class="btn btn-success">Add League</button>
            </form>
        </div>
        <div class="col-sm-6">
