        ...
        <div class="col-md-5 ml-auto">
            <div class="info-area info-horizontal">
                ...
                <div class="description">
                    <h3 class="info-title">{{ __('Affordable') }}</h3>
                    <p class="description">
                        {{ __('Subscriptions are affodable and pocket friendly. You Just Subscribe by paying a sum of $20 Ksh Per Week.') }}
                    </p>
                </div>
            </div>
            <div class="info-area info-horizontal">
                ...
                <div class="description">
                    <h3 class="info-title">{{ __('Accurate Predictions') }}</h3>
                    <p class="description">
                        {{ __('Our Team of Professional use highly versatile softwares making use  machine learning algorithms that are 99% accurate in match prediction. Thats what We Give You!!!') }}
                    </p>
                </div>
            </div>
        </div>
